...
export const uploadFile2 = async(key, data, httpUploadProgressCallback = (event) =>  {console.log(Math.round(event.loaded/event.total*100)+ '% done');}) =>   await fleekStorage.upload({
    apiKey,
    apiSecret,
    key,
    data,
